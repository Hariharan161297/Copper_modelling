    ...
    # Define the possible values for the dropdown menus
       ...
       # Define the widgets for user input
        ...
        if submit_button and flag==0:
            ...
            categorical_columns = [7, 8]  # Assuming 'item_type' is at index 7 and 'status' at index 8
            ...
            selling_price = np.exp(new_pred[0])
...
with tab2: 
        ...
        if csubmit_button and cflag==0:
            ...
            new_sample = np.array([[np.log(float(cquantity_tons)), np.log(float(cselling)),citem_type, capplication, 
