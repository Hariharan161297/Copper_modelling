...
if submit_button and flag==0:
    ...
    categorical_columns = [7]  # Assuming 'item_type' is at index 7 and 'status' at index 8

    # Initialize the LabelEncoder
    label_encoder = LabelEncoder()

    # Fit and transform the categorical columns to integers
    new_sample[:, categorical_columns] = label_encoder.fit_transform(new_sample[:, categorical_columns])
